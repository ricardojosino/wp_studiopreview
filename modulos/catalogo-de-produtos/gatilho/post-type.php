<?php
     ...
     $post_type->Set_labels_name('Produtos');
     $post_type->Set_labels_singular_name('Produtos');
     $post_type->Set_labels_menu_name('Produtos');
     $post_type->Set_labels_name_admin_bar('Produtos');
     $post_type->Set_labels_add_new('Inserir novo produto');
     ...
     $post_type->Set_labels_set_featured_image('Definir capa');
     $post_type->Executar();
