<?php
     ...
     class WidgetImoveis_IfraestruturaDoImovel extends \WP_Widget

     {
          ...
          {
               $id = 'spw-imoveis-infraestrutura-imovel';
               $name = 'SPW IMÓVEIS - Infaestruturas do imóvel';
               $description = array('description' => 'Exibir bloco de infraestrutura.');
          ...
          {
               $lista = get_field('infraestrutura');
...

          {
               ...
               if (!empty($lista)) :
                    ...
                    $array[] = '<div class="spw-imoveis-infraestrutura ' . $instance['class'] . '">';
