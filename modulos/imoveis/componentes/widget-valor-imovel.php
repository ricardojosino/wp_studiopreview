<?php
     ...
     class WidgetImoveis_ValorDoImovel extends \WP_Widget

     {
          ...
          {
               $id = 'spw-imoveis-valor-imovel';
               $name = 'SPW IMÓVEIS - Valor do imóvel';
               $description = array('description' => 'Exibe o valor do imóvel.');
          ...
          public function Valor($instance)
          {
               if (empty($instance['prefixo'])) :
                    return \Spw\Componentes\Ferramentas\Pacote::Moeda_Formatar(get_field('valor_do_imovel'));
               
                         else :
                              return $instance['prefixo'] . ' ' . \Spw\Componentes\Ferramentas\Pacote::Moeda_Formatar(get_field('valor_do_imovel'));
