<?php
     ...
     class WidgetImoveis_MetragensDoImovel extends \WP_Widget

     {
          ...
          {
               $id = 'spw-imoveis-metragens-imovel';
               $name = 'SPW IMÓVEIS - Metragens do imóvel';
               $description = array('description' => 'Exibir bloco de metragens.');

               parent::__construct($id, $name, $description);
          }
          
          
          public function Item($titulo, $value)
          {
               if (!empty($titulo)) :
                    ...
                    $array[] = \Spw\Componentes\Html\Funcoes::Tag('div', array('class' => 'spw-valor'), $value);
                    $array[] = '</div>';
          ...
          {
               $lista = get_field('metragem');
               
               if (!empty($lista)) :
                    
                    $array[] = '<div class="spw-itens">';
                         foreach($lista AS $item) :
                              $array[] = $this->Item($item['titulo'] . ':' , $item['valor'] . ' m&sup2');
                         endforeach;
                    $array[] = '</div>';
...

          {
               ...
               if (!empty($lista)) :
                    ...
                    $array[] = '<div class="spw-imoveis-metragens ' . $instance['class'] . '">';
