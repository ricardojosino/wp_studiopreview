<?php
     ...
     $post_type->Set_labels_name('Imóveis');
     $post_type->Set_labels_singular_name('spw-imoveis');
     $post_type->Set_labels_menu_name('Imóveis');
     $post_type->Set_labels_name_admin_bar('Imóveis');
     $post_type->Set_labels_add_new('Inserir novo imóvel');
