     ...
     class Load
     {
          ...
          protected function Script()
          {
               if (!empty($this->botao_id)) :
                    ...
                    $procura = array('spw_id_botao', 'spw_callback_id', 'spw_data');
                    $replace = array( '"' . $this->botao_id . '"', '"' . $this->callback_id . '"', $this->Data() );
                    
                    $conteudo = file_get_contents( \Spw\Componentes\Path::PathJs('Ajax', 'Load') );
